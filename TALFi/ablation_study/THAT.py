...
class CRNN(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, n_len_seg):
        ...
        # self.cnn = ResNet17(in_samples=4096, in_channels=30, end_channels=512, half_start=False)
        # (batch, seq, feature)
        self.channel_lift = nn.Conv1d(30, 512, 3, 1, 1)
    ...
    def forward(self, x):
        ...
        out = out.view(-1, 4096, 512)
        a, (out, b) = self.rnn(out)
        out2 = a.permute(0, 2, 1)
        # print(out2.shape)
        #  bash TALFi/train_tools/TALFi.sh 8,9
        return out2